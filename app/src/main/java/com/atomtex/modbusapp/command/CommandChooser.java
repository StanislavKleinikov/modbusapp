...
public class CommandChooser {
    ...
    static {
        ...
        btdu3commands.put(READ_ACCUMULATED_SPECTER, BasicCommand.getInstance());
        btdu3commands.put(READ_ACCUMULATED_SPECTER_COMPRESSED_REBOOT, BasicCommand.getInstance());
